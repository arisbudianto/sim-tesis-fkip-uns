...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $pengajuans = PengajuanTesis::with(['mahasiswa', 'pembimbing1', 'pembimbing2', 'logbooks.dosen', 'aktivitasSidangs.pengujiSidangs.dosen', 'pendaftaranSempro', 'pendaftaranSemhas'])->latest()->get();
