    ...
    <div class="login-card">
        ...
        <form action="<?php echo e(route('login.post')); ?>" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="identifier" class="form-control" value="<?php echo e(old('identifier')); ?>" required placeholder="Contoh: S032608001 atau NIP" autofocus>
            </div>
            <div class="form-group">
        ...
        <div class="footer-link">
            Belum punya akun? <a href="<?php echo e(route('register')); ?>">Daftar di sini</a><br>
            <a href="<?php echo e(route('public.index')); ?>" style="display:inline-block; margin-top:10px; color:#64748b;">← Kembali ke Halaman Publik</a>
        </div>
    </div>
</body>
</html>
<?php /**PATH /home/speakver/pgv.speakverse.id/resources/views/auth/login.blade.php ENDPATH**/ ?>