...
<body>
    <nav class="navbar">
        <a href="<?php echo e(route('public.index')); ?>" class="navbar-brand">
            🏛️ SIM-TESIS FKIP UNS
        </a>
        <div class="navbar-nav">
            <a href="<?php echo e(route('public.index')); ?>" class="nav-link">Beranda</a>
            <a href="<?php echo e(route('public.panduan')); ?>" class="nav-link">Panduan SOP</a>
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('dashboard')); ?>" class="nav-link btn-register">Dashboard Saya</a>
                <form action="<?php echo e(route('logout')); ?>" method="POST" style="display:inline;">
                    <?php echo csrf_field(); ?>
                    <button type="submit" class="nav-link btn-login" style="border:none; cursor:pointer;">Keluar</button>
                </form>
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="nav-link btn-login">Masuk (Login)</a>
                <a href="<?php echo e(route('register')); ?>" class="nav-link btn-register">Daftar Akun</a>
            <?php endif; ?>
        </div>
    </nav>
    ...
    <div class="hero">
        ...
        <div>
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('dashboard')); ?>" class="nav-link btn-register" style="padding: 12px 24px; font-size: 15px;">Masuk ke Dashboard Sistem</a>
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="nav-link btn-register" style="padding: 12px 24px; font-size: 15px;">Mulai Akses SIM-TESIS</a>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="container">
        <div class="grid-stats">
            <div class="card-stat">
                ...
                <div class="val"><?php echo e($stats['tahap_1_bimbingan']); ?></div>
            </div>
            <div class="card-stat">
                <h3>Tahap 2: Sempro</h3>
                <div class="val"><?php echo e($stats['tahap_2_sempro']); ?></div>
            </div>
            <div class="card-stat">
                <h3>Tahap 3: Semhas</h3>
                <div class="val"><?php echo e($stats['tahap_3_semhas']); ?></div>
            </div>
            <div class="card-stat">
                <h3>Tahap 4: Ujian Tesis</h3>
                <div class="val"><?php echo e($stats['tahap_4_ujian']); ?></div>
            </div>
            <div class="card-stat" style="border-bottom-color: #16a34a;">
                <h3>Siap Yudisium</h3>
                <div class="val"><?php echo e($stats['selesai_yudisium']); ?></div>
            </div>
        </div>
