...
<style>
    ...
    .kop-logo img { width: 92px; }
    .kop-text { padding-left: 14px; }
    .kop-text .unit-name { font-size: 15px; font-weight: bold; color: #000; margin: 0 0 2px 0; }
    .kop-text .prodi-name { font-size: 13px; font-weight: bold; color: #000; margin: 0 0 5px 0; }
    .kop-text p { margin: 0; font-size: 10px; line-height: 1.45; color: #1a1a1a; }
    .kop-line { border-bottom: 3.5px solid #000; margin: 8px 0 12px 0; }
