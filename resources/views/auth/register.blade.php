    ...
    <div class="reg-card">
        ...
        <form action="{{ route('register.post') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="identifier" class="form-control" value="{{ old('identifier') }}" required placeholder="Contoh: S032608001">
            </div>
            <div class="form-group">
                <label>Email Resmi (@uns.ac.id / @student.uns.ac.id):</label>
                <input type="email" name="email" class="form-control" value="{{ old('email') }}" required placeholder="nama@student.uns.ac.id">
            </div>
            <div class="form-group">
        ...
        <div class="footer-link">
            Sudah memiliki akun? <a href="{{ route('login') }}">Masuk di sini</a><br>
            <a href="{{ route('public.index') }}" style="display:inline-block; margin-top:8px; color:#64748b;">← Halaman Publik</a>
        </div>
    </div>
